...
public class CaveOres {
    ...
    public void preinit(FMLPreInitializationEvent event) {
        ...
        if (!denseOres) COAL_ENTRY.addDefaultOre(17, 9, Blocks.COAL_BLOCK.getDefaultState());
        ...
        if (!denseOres) IRON_ENTRY.addDefaultOre(17, 9, Blocks.IRON_BLOCK.getDefaultState());
        ...
        if (!denseOres) GOLD_ENTRY.addDefaultOre(17, 9, Blocks.GOLD_BLOCK.getDefaultState());
        ...
        if (!denseOres) LAPIS_ENTRY.addDefaultOre(17, 9, Blocks.LAPIS_BLOCK.getDefaultState());
        ...
        if (!denseOres) REDSTONE_ENTRY.addDefaultOre(17, 9, Blocks.REDSTONE_BLOCK.getDefaultState());
        ...
        if (!denseOres) DIAMOND_ENTRY.addDefaultOre(17, 9, Blocks.DIAMOND_BLOCK.getDefaultState());
        ...
        if (!denseOres) EMERALD_ENTRY.addDefaultOre(17, 9, Blocks.EMERALD_BLOCK.getDefaultState());
        ...
        if (!denseOres) QUARTZ_ENTRY.addDefaultOre(9, 4, Blocks.QUARTZ_BLOCK.getDefaultState());
    ...
    public static BiPredicate<World, BlockPos> biomeValidator(BiomeGenBase biome) {
